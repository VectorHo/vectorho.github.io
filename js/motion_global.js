$(document).ready(function() {
  ...
  var sidebarToggleLineStatusInit = {
    width: '100%',
    opacity: 1,
    left: 0,
    rotateZ: 0,
  ...
  var sidebarToggleLine1stStatusArrow = {
    width: '50%',
    rotateZ: '-45deg',
    top: '2px'
  };
  var sidebarToggleLine1stStatusClose = {
    width: '100%',
    rotateZ: '-45deg',
    top: '5px'
  };
  ...
  var sidebarToggleLine2ndStatusArrow = {
    width: '90%'
  };
  var sidebarToggleLine2ndStatusClose = {
    opacity: 0
  };

  var sidebarToggleLine3rdStatusInit = sidebarToggleLineStatusInit;
  var sidebarToggleLine3rdStatusArrow = {
    width: '50%',
    rotateZ: '45deg',
    top: '-2px'
  };
  var sidebarToggleLine3rdStatusClose = {
    width: '100%',
    rotateZ: '45deg',
    top: '-5px'
  };
